...
int persons_altaPersona(Persona* persona)
{
    ...
    if(persona != NULL)
    {
        if(utn_getCadena(nombreAux, NOMBRE_LIMITE, REINTENTOS, "Ingrese el nombre: ", "Error de ingreso. ") == 0
            && utn_getInt(&edadAux, REINTENTOS, 0, 200, "Ingrese la edad: ", "Error de ingreso. ") == 0
            && utn_getCadena(dniAux, DNI_LIMITE, REINTENTOS, "Ingrese el DNI con separador de miles: ", "Error de ingreso. ") == 0
